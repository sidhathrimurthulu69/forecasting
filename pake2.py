...
**In beta mode**
Created by : sidha ---
Code available here: https://github.com/sidhathrimurthulu69/forecasting/blob/main/tonne.csv
"""
...
if df is not None:
    ...
    image = Image.open(r"C:\Users\sidda\Pictures\Screenshots\Screenshot 2023-04-02 002544.png")

    st.image(image, caption='evalute metric values')
